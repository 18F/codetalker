...
exports.q = function(req, res) {
  ...
  if (year == '2007' || year == '2012') { 
    ...
    if (query.field) {
      results = removeUnwantedFields(results, query.field)
    };
  ...
  function removeUnwantedFields (input, fields) {
    // Remove properties from returned objects if they are
    // missing from `fields`
