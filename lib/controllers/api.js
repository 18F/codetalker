...
function genericHandler (req, res, model_call) {

  try {
    model_call(req, sendResults, returnError);
  } catch(e) {
    returnError(400, e);
    return;
  }
...
exports.contractor = function(req, res) {
  return genericHandler(req, res, model.sendOneContractor);
};
